...
void draw(){
 ...
 if(showControls){
   ...
   fill(currColor,172);
    ...
    fill(210,172);
    ellipse(0,0,rectWidth/2,rectWidth/2);
  }
...
void mousePressed(){
 ...
 if(mouseX < rectWidth+10 && mouseY < rectHeight+10 && showControls){
 ...
 }else if(mouseX < rectWidth+10 && mouseY > rectHeight+10 && mouseY < rectHeight+rectWidth+10 && showControls){
 ...
 }else if(!showControls && sqrt(sq(mouseY)+sq(mouseX)) < rectWidth){
